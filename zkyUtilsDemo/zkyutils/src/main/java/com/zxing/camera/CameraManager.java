...
public final class CameraManager {
    ...
    private CameraManager(Context context) {
        ...
        MIN_FRAME_WIDTH = DeviceUtils.dip2px(context, 120);
        MIN_FRAME_HEIGHT = DeviceUtils.dip2px(context, 120);
        MAX_FRAME_WIDTH = DeviceUtils.dip2px(context, 240);
        MAX_FRAME_HEIGHT = DeviceUtils.dip2px(context, 180);
    ...
    public void initFramingRect() {
        ...
        if (type == TYPE_BAR_CODE) {
            int SCREEN_WIDTH = getContext().getResources().getDisplayMetrics().widthPixels;
            framingRect = new Rect(0, topOffset, SCREEN_WIDTH, topOffset + height);
        } else {
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height) {
        ...
        // Log.v("kk", "==========rect:" + rect.toShortString());
        // int SCREEN_WIDTH =
